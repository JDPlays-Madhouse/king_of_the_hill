...
export const weaponObjects = {
	...
	nuke: {
		...
		command: ["nuke", "explosion", "mushroom"],
	},
	"200 IQ": {
		file: "200IQ.png",
		"tense 1": "their",
	...
	"T1 Diesel Train": {
		...
		displayName: "Diesel Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-20px) rotate(30deg) scale(1.5) scaleX(-1); width: 50px;",
		right:
			"transform: translate(-25px,-20px) rotate(-30deg) scale(2); width: 50px;",
		command: [],
	},
	"T2 Diesel Train": {
		file: "LocomotiveT2Diesel.png",
		displayName: "Mega Diesel Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-12px) rotate(30deg) scale(1.5) scaleX(-1); width: 50px;",
		right:
			"transform: translate(-23px,-12px) rotate(-30deg) scale(2); width: 50px;",
		command: [],
	},
	"T1 Steam Train": {
		file: "LocomotiveT1Steam.png",
		displayName: "Steam Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-20px) rotate(30deg) scale(1.5) scaleX(-1); width: 50px;",
		right:
	...
	"T2 Steam Train": {
		file: "LocomotiveT2Steam.png",
		displayName: "Mega Steam Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-12px) rotate(30deg) scale(2) scaleX(-1); width: 50px;",
		right:
			"transform: translate(-23px,-12px) rotate(-30deg) scale(2); width: 50px;",
	...
	"T1 Hydrogen Train": {
		file: "LocomotiveT1Hydrogen.png",
		displayName: "Hydrogen Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-20px) rotate(30deg) scale(1.5) scaleX(-1); width: 50px;",
		right:
	...
	"T2 Hydrogen Train": {
		file: "LocomotiveT2Hydrogen.png",
		displayName: "Mega Hydrogen Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-12px) rotate(30deg) scale(2) scaleX(-1); width: 50px;",
		right:
	...
	"Captains Train": {
		file: "LocomotiveCaptains.png",
		displayName: "Golden Choo",
		"tense 1": "the",
		"tense 2": "that",
		left: "transform: translate(50px,-40px) rotate(30deg) scale(1.5) scaleX(-1); width: 50px;",
		right:
			"transform: translate(-25px,-40px) rotate(-30deg) scale(1.5); width: 50px;",
		command: [],
	},
};
...
const tiered_weapons = {
	...
	Train: {
		name: "Train",
		command: ["choo", "train", "loco"],
		types: [
			{ name: "Steam", command: ["steam train", "steam"] },
			{ name: "Diesel", command: ["diesel train", "diesel", "desel", "choo"] },
			{ name: "Hydrogen", command: ["hydrogen"] },
			{ name: "Captains", command: ["gold", "golden choo", "captain"] },
		],
	},
};
...
export function userTieredWeapon(lowerMessage, weapon_name) {
	console.log({ lowerMessage, weapon_name });
	let tier_choice = "T2";
	...
	if (weapon.name === "Train" && type_choice === "Captains") {
		console.log("Captains Train");
		return "Captains Train";
	}
	// type_choice = type_choice === "Empty" ? "" : type_choice;
	type_choice = type_choice === "Tank" ? "Fluid Tank" : type_choice;
	const temp = weaponChoice.pop();
	weaponChoice.push(type_choice);
	weaponChoice.push(temp);

	console.log(weaponChoice);
	if (tier_choice === "T3") {
		if (weapon.name === "Train") {
			weaponChoice[0] = "T2";
		}
